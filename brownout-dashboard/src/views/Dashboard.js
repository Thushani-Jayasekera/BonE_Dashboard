...
function Dashboard(props) {
  ...
  React.useEffect(() => {
    const ws = new WebSocket('ws://34.100.218.112:8000/metrics/battery');
  ...
  React.useEffect(() => {
    const ws = new WebSocket('ws://34.100.218.112:8000/metrics/power');
    ws.addEventListener('message', (event) => {
  ...
  React.useEffect(() => {
    const ws = new WebSocket('ws://34.100.218.112:8000/metrics/pods');
    ws.addEventListener('message', (event) => {
  ...
  React.useEffect(() => {
    const ws = new WebSocket('ws://34.100.218.112:8000/metrics/sla');
    ws.addEventListener('message', (event) => {
      try {
